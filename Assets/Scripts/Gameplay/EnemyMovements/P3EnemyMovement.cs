...
public class P3EnemyMovement : Photon.MonoBehaviour {
	...
	{
		if (wavepointIndex == P3Waypoints.points.Length-2) 
		{
			WarpToMidLane ();
		}

		if (wavepointIndex >= P3Waypoints.points.Length-1) 
		{
			return;
		}

		wavepointIndex++;
		target = P3Waypoints.points [wavepointIndex];
	}
